...
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(value = {StaticDataNotFoundException.class})
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<VndErrors> notFoundException(StaticDataNotFoundException e, WebRequest request) {
    ...
    public ResponseEntity<VndErrors> NotEnoughInventoryException(NotEnoughInventoryException e, WebRequest request) {
        VndErrors error = new VndErrors(request.toString(), "Not found : " + e.getMessage());
        ResponseEntity<VndErrors> responseEntity = new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
        return responseEntity;
    }

    @ExceptionHandler(value = {ExceedNumberLengthLimitationException.class})
    @ResponseStatus(HttpStatus.NOT_ACCEPTABLE)
    public ResponseEntity<VndErrors> ExceedNumberLengthLimitationException(ExceedNumberLengthLimitationException e, WebRequest request) {
        VndErrors error = new VndErrors(request.toString(), "Not found : " + e.getMessage());
        ResponseEntity<VndErrors> responseEntity = new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
        return responseEntity;
    }
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<VndErrors> RequestNotFoundException(RequestNotFoundException e, WebRequest request) {
        VndErrors error = new VndErrors(request.toString(), "Not found : " + e.getMessage());
        ResponseEntity<VndErrors> responseEntity = new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
        return responseEntity;
    }
